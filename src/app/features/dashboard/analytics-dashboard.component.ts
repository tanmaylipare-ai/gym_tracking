...
@Component({
  ...
  <div class="px-4 pt-6 pb-8 safe-top">
      ...
      <p class="text-sm text-gym-muted">
        This page is under development. Please check back later for the full analytics dashboard.
      </p>
    </div>
  `,
})
...
// The below code is commented for initial commit. It will be uncommented and used in future commits when the analytics dashboard is implemented correctly.
