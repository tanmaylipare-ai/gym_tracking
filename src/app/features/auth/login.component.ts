...
@Component({
  ...
  template: `
    ...
    <div
      class=" h-dvh bg-gym-bg flex flex-col justify-center px-6 safe-top safe-bottom"
    >
      <div class="flex-1 flex items-center">
        <div class="w-full max-w-md mx-auto">
          ...
          <div class="mb-10 text-center">
            <div
              class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gym-accent mb-4"
            >
              <svg
              ...
              >
                <path
                  d="M3 6h3m15 0h-3M3 12h18M6 6v12M18 6v12M9 18h6"
                  stroke="currentColor"
                  stroke-width="2"
            ...
            <p class="text-gym-muted mt-1 text-sm">
          ...
          <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-4">
            <div>
              <label class="block text-sm font-medium text-gym-muted mb-2"
                >Email</label
              >
              <input
                type="email"
            ...
            <div>
              ...
              <a
                ...
                class="text-xs text-gym-accent font-medium"
                >Forgot password?</a
              >
            </div>
          ...
          <p class="text-center text-gym-muted text-sm mt-8">
            No account?
            <a routerLink="/register" class="text-gym-accent font-medium ml-1"
              >Create one</a
            >
          </p>
        </div>
...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.auth.ping().subscribe({
      error: () => {}, // console ping fails/times out
    });
  }
